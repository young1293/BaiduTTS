...
public class UiMessageListener extends MessageListener {
    ...
    public void onSynthesizeDataArrived(String utteranceId, byte[] data, int progress) {
        ...
        Log.e(TAG, "---onSynthesizeDataArrived" + mainHandler.obtainMessage(UI_CHANGE_SYNTHES_TEXT_SELECTION, progress, 0));
    ...
    public void onSpeechProgressChanged(String utteranceId, int progress) {
        ...
        Log.e(TAG, "--onSpeechProgressChanged" + mainHandler.obtainMessage(UI_CHANGE_SYNTHES_TEXT_SELECTION, progress, 0));
