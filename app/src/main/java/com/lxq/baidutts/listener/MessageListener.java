package com.lxq.baidutts.listener;
...
public class MessageListener implements SpeechSynthesizerListener, MainHandlerConstant {
    ...
    public void onSynthesizeStart(String utteranceId) {
        Log.e(TAG, "准备开始合成,序列号:" + utteranceId);
    ...
    public void onSynthesizeFinish(String utteranceId) {
        Log.e(TAG, "合成结束回调, 序列号:" + utteranceId);
    ...
    public void onSpeechStart(String utteranceId) {
        Log.e(TAG, "播放开始回调, 序列号:" + utteranceId);
    ...
    public void onSpeechFinish(String utteranceId) {
        Log.e(TAG, "播放结束回调, 序列号:" + utteranceId);
    ...
    public void onError(String utteranceId, SpeechError speechError) {
        Log.e(TAG, "错误发生：" + speechError.description + "，错误编码："
